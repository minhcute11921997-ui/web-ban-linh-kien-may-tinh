...
ALTER TABLE orders
  ADD COLUMN IF NOT EXISTS customer_name VARCHAR(255) DEFAULT NULL AFTER notes,
  ADD COLUMN IF NOT EXISTS customer_phone VARCHAR(20) DEFAULT NULL AFTER customer_name,
  ADD COLUMN IF NOT EXISTS shipping_address TEXT DEFAULT NULL AFTER customer_phone,
  ADD COLUMN IF NOT EXISTS shipping_fee DECIMAL(15,2) DEFAULT 0 AFTER shipping_address,
  ADD COLUMN IF NOT EXISTS discount_amount DECIMAL(15,2) DEFAULT 0 AFTER shipping_fee;
