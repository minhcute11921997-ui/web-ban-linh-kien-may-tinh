...
const CartPage = () => {
  ...
  if (loading) return (
    <div className="flex flex-col justify-center items-center min-h-screen gap-3 text-gray-400">
    ...
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-6xl mx-auto px-4">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-500 pl-1">{items.length} sản phẩm</p>
        </div>
        ...
        {items.length === 0 ? (
          <div className="bg-white rounded-2xl shadow-sm p-12 text-center">
            <div className="flex flex-col items-center gap-3 text-gray-400">
              ...
              <p className="text-gray-500 text-lg">Giỏ hàng đang trống</p>
              <button
                onClick={() => navigate('/')}
                className="mt-2 flex items-center gap-2 text-blue-600 hover:text-blue-700 font-medium text-sm transition-colors"
              >
              ...
              <div className="flex items-center justify-between mb-6">
                ...
                <div className="flex items-center gap-6">
                  <button
                    ...
                    className="flex items-center gap-1.5 text-red-500 hover:text-red-700 hover:bg-red-50 px-3 py-2 rounded-lg transition font-semibold text-sm disabled:opacity-50 disabled:cursor-not-allowed"
                  >
                    <Trash2 size={15} />
                    Xóa
                  </button>
                ...
                {items.map(item => (
                  ...
                  >
                      ...
                      {item.discount_percent > 0 ? (
                        <div>
                          <div className="flex items-center gap-2">
                            ...
                            <span className="flex items-center gap-0.5 text-xs bg-red-500 text-white px-1.5 py-0.5 rounded-full font-medium">
                              <Tag size={10} />
                    ...
                    <div className="flex items-center border border-gray-300 rounded-lg bg-white">
                      ...
                      <input
                        ...
                        onBlur={(e) => {
                          ...
                          setInputValues({ ...inputValues, [item.id]: undefined });
                        }}
                    ...
                    <button
                      ...
                      className="flex-shrink-0 w-8 h-8 flex items-center justify-center text-white bg-blue-500 hover:bg-red-600 rounded-lg transition shadow-md hover:shadow-lg"
                    >
