    ...
    const fetchData = async () => {
      ...
      try {
        ...
        const specRes = await fetch(
          `${import.meta.env.VITE_API_URL}/api/products/${id}/specs`
        );
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="flex items-center gap-4 text-sm text-gray-600">
            ...
            <div className="flex items-center border border-gray-300 rounded-lg overflow-hidden">
              <button
                className="w-9 h-9 bg-gray-100 hover:bg-gray-200 text-lg transition"
      ...
      <div className="bg-white rounded-2xl shadow-md p-8 mt-6">
        ...
        {reviewPagination?.totalPages > 1 && (
          <div className="flex justify-center gap-2 mt-6">
            {Array.from(
              { length: reviewPagination.totalPages },
              (_, i) => i + 1
            ).map((p) => (
              <button
                key={p}
