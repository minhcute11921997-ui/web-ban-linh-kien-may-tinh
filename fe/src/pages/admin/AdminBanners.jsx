...
import { ImageUp, Loader2, Save, ExternalLink } from "lucide-react";
...
export default function AdminBanners() {
  ...
  const loadBanners = async () => {
    try {
      ...
      const nextBanners = defaultBanners.map((defaultBanner) => {
        const apiBanner = apiBanners.find(
          (item) => Number(item.position) === defaultBanner.position
        );

        return {
          ...defaultBanner,
          image_url: apiBanner?.image_url || null,
            ...
            return (
              ...
              >
                ...
                <div className="p-4 space-y-4">
                  <div className="aspect-[16/7] bg-gray-100 rounded-md overflow-hidden border border-gray-100">
                    <img
                      src={imageSrc}
