                ...
                <td className="px-6 py-3">
                  {editId === u.id ? (
                    <input value={editForm.full_name}
                      ...
                      className="border border-gray-200 px-2 py-1 rounded-lg text-sm w-full" />
                  ) : (
                  ...
                  {editId === u.id ? (
                    <div className="flex gap-2">
                      <button onClick={handleSave}
                        className="text-green-600 hover:text-green-700 font-medium cursor-pointer">Lưu</button>
                      <button onClick={() => setEditId(null)}
                        className="text-gray-400 hover:text-gray-600 font-medium cursor-pointer">Hủy</button>
                    </div>
                  ) : (
